            ...
            <div class="container" style="width: 750px">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="{{ route('vendor.product.update', [$vendor->id, $product->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <img src="/images/uploads/products/{{ $product->product_avatar }}" id="preview_img"
                                     class="img-fluid"
